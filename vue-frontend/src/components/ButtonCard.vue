        ...
        <div class="card-content">
          <div class="columns is-mobile is-vcentered">
            ...
            <div class="column is-narrow">
              <div class="card-icon pb-3 pt-4 px-5 has-background-success has-text-light" style="cursor: pointer;" v-if="card.value === true" @click="sendClickEvent">
              ...
              <div class="card-icon pb-3 pt-4 px-5 has-background-grey-dark has-text-white" style="cursor: pointer;" v-else @click="sendClickEvent">
