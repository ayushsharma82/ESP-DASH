    ...
    <div class="card">
      ...
      <div class="card-content">
        <header class="columns is-gapless is-mobile">
          <div class="column is-narrow sicon sicon-xs is-inline has-text-primary align-middle">
            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
              ...
              <g id="Stockholm-icons-/-Code-/-Commit" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <path
                  ...
                  id="Oval-15" fill="#335EEA"></path>
              </g>
            </svg>
          </div>
          <h4 class="column" style="margin-left: 0.8rem"><input class="slider is-fullwidth"
              @change="sendValue"
