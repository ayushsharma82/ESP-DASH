...
```
- **Signature:** `void setOptions(const char* options[], size_t count)`
- **Parameters:**
...
```
- **Signature:** `const char* options()`
- **Parameters:** None
- **Returns:** `const char*` — The current options as a comma-separated string.
