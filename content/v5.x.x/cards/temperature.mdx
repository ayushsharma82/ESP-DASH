...
description: A card specifically designed to display temperature values. Updated for ESP-DASH v5 API.
---
...
<img className="my-6 hidden dark:block" src="/img/v5/cards/dark/temperature.png" width="280px" alt="Preview" />
<img className="my-6 dark:hidden" src="/img/v5/cards/light/temperature.png" width="280px" alt="Preview" />
